...
io.sockets.on('connection', function(socket) {
  ...
  socket.on('chat message', function(text, counter) {
    Chatroom.findById(socket.room, function(err, r){
        console.log(socket.username, "sends #", counter, ":", text, "to", socket.room, "private: ", r.secret);
  ...
  socket.on('disconnect', function() {
    ...
    Chatroom.findById(socket.room, function(err, obj) {
        console.log("disconnect~~~~~~~~~~~~~~~", obj.users)
        var on = false;
        obj.users.forEach(function(user, id, arr) {
        if (user in online) {
            on = true;
